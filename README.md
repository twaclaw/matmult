...
This hardware accelerator provides a 5x speedup compared to NumPy. This performance  is achieved at expenses of a high  utilization of FPGA resources.   It should be noted that NumPy uses a more efficient algorithm than the naive one implemented in this example.
