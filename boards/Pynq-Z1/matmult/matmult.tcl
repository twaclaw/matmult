...
proc create_root_design { parentCell } {
  ...
  # Create instance: matmult_accel_0, and set properties
  set matmult_accel_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:matmult_accel:1.0 matmult_accel_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins matmult_accel_0/src]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins matmult_accel_0/s_axi_AXILiteS]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs matmult_accel_0/s_axi_AXILiteS/Reg] -force
